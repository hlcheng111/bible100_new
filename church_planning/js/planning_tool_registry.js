...
(function (global) {
  ...
  var TOOLS = [
    { id: "spiritual", path: "信徒靈性生命健康自我審查.html", label: "信徒靈命健康", category: "靈命與真理", ctv: ["P", "F"], blurb: "全會友自評 · 微型教會必選", status: "live" },
    { id: "pastoral", path: "pastoral-spiritual-survey-pro.html", label: "領袖健康診斷", category: "靈命與真理", ctv: ["P", "F"], blurb: "教牧／核心同工負擔與節奏", status: "live" },
    ...
    { id: "urgent", path: "important-urgent-matrix.html", label: "重要 vs 緊急", category: "治理與優先", ctv: ["G"], blurb: "優先序與取捨", status: "live" },
    { id: "smart", path: "smart-planning.html", label: "教會版 SMART", category: "目標衡量", ctv: ["G", "C"], blurb: "可守住的事工目標", status: "live" },
    ...
    /* RACI 為步驟2主入口，不列入步驟3子選單；戰情室仍引用 */
    { id: "raci", path: "planning/raci-reflection.html", label: "RACI 權責反思", category: "治理與優先", ctv: ["G", "R"], blurb: "誰主責、誰配合 · 步驟2", status: "live", sidebarStep3: false }
  ];
