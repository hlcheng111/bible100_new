...
(function (global) {
  ...
  var SITE_SEARCH_INDEX = [
    ...
    { title: 'SWOT 規劃', path: 'church_planning/swot-planning.html', keywords: 'SWOT,策略,規劃,swot', layer: 'strategy' },
    { title: 'SMART 目標', path: 'church_planning/smart-planning.html', keywords: 'SMART,目標,smart,okr', layer: 'strategy' },
    { title: 'PDCA 循環', path: 'church_planning/pdca-planning.html', keywords: 'PDCA,改善,pdca', layer: 'strategy' },
