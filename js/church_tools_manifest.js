...
(function (global) {
  ...
  var ENTRIES = [
    /* --- 5F 步驟導覽 --- */
    { layer: "guide", id: "step2_raci", label: "步驟2 權責導覽", path: "church_planning/guides/guide_step2_raci.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "guide", id: "step4_ctv", label: "步驟4 戰情室導覽", path: "church_planning/guides/guide_step4_ctv.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "guide", id: "step5_strategy", label: "步驟5 策略導覽", path: "church_planning/guides/guide_step5_strategy.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "guide", id: "step6_crm", label: "步驟6 CRM 降落", path: "church_planning/guides/guide_step6_crm.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },

    /* --- 5F 規劃問卷（14+1 RACI）--- */
    { layer: "planning", id: "spiritual", label: "信徒靈命健康", path: "church_planning/信徒靈性生命健康自我審查.html", targetPath: "church_planning/tools/tool_spiritual.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "pastoral", label: "領袖健康診斷", path: "church_planning/pastoral-spiritual-survey-pro.html", targetPath: "church_planning/tools/tool_pastoral.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "shape", label: "SHAPE 恩賜", path: "church_planning/shape-gifts-assessment.html", targetPath: "church_planning/tools/tool_shape.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "competency", label: "事奉能力模型", path: "church_planning/ministry-competency-assessment.html", targetPath: "church_planning/tools/tool_competency.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "alda", label: "ALDA 領導力", path: "church_planning/12 Apostles Leadership Assessment.html", targetPath: "church_planning/tools/tool_alda.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "ministry8020", label: "教會版 80/20", path: "church_planning/ministry-8020-planning.html", targetPath: "church_planning/tools/tool_ministry8020.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "urgent", label: "重要 vs 緊急", path: "church_planning/important-urgent-matrix.html", targetPath: "church_planning/tools/tool_urgent.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "smart", label: "教會版 SMART", path: "church_planning/smart-planning.html", targetPath: "church_planning/tools/tool_smart.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "pdca", label: "教會版 PDCA", path: "church_planning/Church_Governance_PDCA_cycle.html", targetPath: "church_planning/tools/tool_pdca.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "kpiokr", label: "KPI/OKR 對齊", path: "church_planning/kpi-okr-alignment.html", targetPath: "church_planning/tools/tool_kpiokr.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "johari", label: "Johari 盲點", path: "church_planning/johari-window-assessment.html", targetPath: "church_planning/tools/tool_johari.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "swot", label: "教會版 SWOT", path: "church_planning/Church_Governance_SWOT_matrix.html", targetPath: "church_planning/tools/tool_swot.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "ncd", label: "NCD 教會健康", path: "church_planning/Church_Health_NCD_planning.html", targetPath: "church_planning/tools/tool_ncd.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "disc", label: "DISC 溝通風格", path: "church_planning/disc-profile-assessment.html", targetPath: "church_planning/tools/tool_disc.html", status: "planned", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "mbti", label: "MBTI 性格傾向", path: "church_planning/mbti-self-awareness.html", targetPath: "church_planning/tools/tool_mbti.html", status: "planned", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "culture", label: "文化契合度", path: "church_planning/culture-alignment-assessment.html", targetPath: "church_planning/tools/tool_culture.html", status: "planned", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "raci", label: "RACI 權責反思", path: "church_planning/planning/raci-reflection.html", targetPath: "church_planning/tools/tool_raci.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "assessment_hub", label: "健康診斷中心", path: "church_planning/assessment-os-hub.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
    { layer: "planning", id: "war_room", label: "健康雷達戰情室", path: "church_planning/cta-os-war-room.html", status: "live", sidebar: "church_planning/sidebar_plan_v5_preview.html" },
