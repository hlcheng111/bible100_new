...
(function (global) {
  var PAGE_STRINGS = {
    'zh-Hant': {
      ...
      qna_title: 'D · 牧養問答',
      qna_lead: '剛讀完有疑問？先複製 Prompt 問 AI，再請牧者／老師審核。',
      ai_title: 'E · 更深讀',
      ai_lead: '背景、原文、三鏡頭導讀 — 幫你讀懂這段，不取代牧者。',
    },
    en: {
      ...
      qna_lead: 'Finished reading? Copy a Prompt for AI, then ask your pastor to review.',
      ai_title: 'E · Go deeper',
      ai_lead: 'Background, words, guided read — not a substitute for pastors.',
    },
    vi: {
